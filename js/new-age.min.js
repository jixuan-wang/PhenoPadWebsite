...
! function(e) {
    ...
    window.addEventListener('scroll',function(){
        ...
        var bodyRect = document.body.getBoundingClientRect(),
            ...
            hwr_offset = document.getElementById('hwrVideo').getBoundingClientRect().top - bodyRect.top - (0.3* $(window).height()),
            speech_offset = document.getElementById('speechVideo').getBoundingClientRect().top - bodyRect.top - (0.3* $(window).height()),
            cds_offset = document.getElementById('cdsVideo').getBoundingClientRect().top - bodyRect.top - (0.3* $(window).height()),
            addin1_offset = document.getElementById('addinVideo1').getBoundingClientRect().top - bodyRect.top - (0.3* $(window).height()),
            addin2_offset = document.getElementById('addinVideo1').getBoundingClientRect().top - bodyRect.top - (0.5* $(window).height());
