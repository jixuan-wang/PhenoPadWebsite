    ...
    window.addEventListener('load',function(){
        ...
        if( /iPhone|iPad|iPod/i.test(navigator.userAgent) ) {
            items.foreach(function(element){
                document.getElementById(element.toString()).autoplay = true;
                document.getElementById(element.toString()).playsinline = true;
                document.getElementById(element.toString()).load();
            });
        }
    });
}(jQuery);